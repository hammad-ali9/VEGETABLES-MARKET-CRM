export const Icon = ({ name, size = 18, className = '' }) => {
  const paths = {
    ...
    'eye-off': <><path d="M9.9 4.2A8.6 8.6 0 0 1 12 4c6.5 0 10 8 10 8a13 13 0 0 1-1.6 2.7M14.1 14.1A3 3 0 0 1 9.9 9.9M6.3 6.3A13 13 0 0 0 2 12s3.5 8 10 8a8.7 8.7 0 0 0 5.7-2.3"/><path d="M2 2l20 20"/></>,
    ...
    handshake: <><path d="M9 11L7 13l-4-4 4-4 2 2"/><path d="M15 11l2 2 4-4-4-4-2 2"/><path d="M7 13l2 2 2-2 2 2 2-2 2 2"/></>,
  };
  return (
